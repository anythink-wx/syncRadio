...
class mp3file
{
    ...
    protected $bitpos;
    protected $mp3data;
    public function __construct($filename,$file_size)
    {
        $this->powarr  = array(0=>1,1=>2,2=>4,3=>8,4=>16,5=>32,6=>64,7=>128);
        $this->blockmax= 1024;
        
        $this->mp3data = array();
        $this->mp3data['Filesize'] = $file_size; //filesize($filename);
	...
	public function get_time(){
		$rs = 1152 / $this->mp3data['Sampling Rate'];  //26.12
		$time = $this->mp3data['Filesize'] / $this->mp3data['Frame Size'] * $rs;
		return round($time);
	}
